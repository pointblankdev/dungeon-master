    ...
    (let
        ...
        (and (> craft-reward u0)
            (begin
                ...
                (try! (as-contract (contract-call? .dme000-governance-token dmg-mint craft-reward recipient)))
            )
        )
    ...
    (let
        ...
        (and (> salvage-reward u0)
            (begin
                ...
                (try! (as-contract (contract-call? .dme000-governance-token dmg-mint salvage-reward recipient)))
            )
        )
	...
	(let
        ...
        (and (> transfer-reward u0)
            (begin
                ...
                (try! (as-contract (contract-call? .dme000-governance-token dmg-mint transfer-reward recipient)))
            )
        )
