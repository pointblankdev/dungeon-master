...
(define-read-only (has-required-experience (who principal))
    (unwrap-panic (contract-call? .experience has-percentage-balance who (var-get required-exp-percentage)))
)
...
(define-public (add-liquidity (amount uint))
    (let
        ...
        (try! (contract-call? .liquid-staked-leo transfer amount-a tx-sender contract none))
...
(define-public (remove-liquidity (amount uint))
    (let
        ...
        (try! (as-contract (contract-call? .liquid-staked-leo transfer amount-a contract sender none)))
