...
(define-data-var token-name (string-ascii 32) "Wooo!")
    ...
    (let
        ...
        (and (> craft-reward u0)
            (begin
                ...
                (try! (as-contract (contract-call? .dme000-governance-token dmg-mint craft-reward sender)))
            )
        )
    ...
    (let
        ...
        (and (> salvage-reward u0)
            (begin
                ...
                (try! (as-contract (contract-call? .dme000-governance-token dmg-mint salvage-reward sender)))
            )
        )
	...
	(let
        ...
        (and (> transfer-reward u0)
            (begin
                ...
                (try! (as-contract (contract-call? .dme000-governance-token dmg-mint transfer-reward sender)))
            )
        )
