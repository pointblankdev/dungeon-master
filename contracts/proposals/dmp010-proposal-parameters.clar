...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? .dme002-proposal-submission set-parameter "proposal-duration" u720))
		...
		(try! (contract-call? .dme002-proposal-submission set-parameter "minimum-proposal-start-delay" u36))
        (ok true)
	)
)
